...
interface Props { name?: string; email?: string; phone?: string; message?: string }
  ...
  <Html lang="pt-BR" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Mensagem recebida! ✉️</Heading>
        <Text style={text}>{name ? `Olá ${name},` : 'Olá,'} recebemos sua mensagem e responderemos o mais breve possível.</Text>
        <Text style={text}>Agradecemos seu contato e interesse no Sócio do Tabuleiro!</Text>
