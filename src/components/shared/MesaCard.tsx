...
export function MesaCard({
  ...
  return (
    <div
      ...
      className={`group relative rounded-xl border bg-card overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-primary ${
        sponsored ? "border-secondary/30 sponsored-glow" : "border-border hover:border-border-strong"
      }`}
    >
      ...
      <div className="p-5">
        ...
        {/* Title */}
        <h3 className="text-h4 text-foreground group-hover:text-primary transition-colors mb-1.5 line-clamp-1">
          {mesa.title}
        </h3>
