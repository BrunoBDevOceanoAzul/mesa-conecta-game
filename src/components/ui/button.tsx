...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        hero: "bg-primary text-primary-foreground shadow-md shadow-primary/15 hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20 hover:scale-[1.02] active:scale-[0.98]",
        "hero-outline":
          "border border-border text-foreground hover:bg-surface-hover hover:border-primary/30 hover:shadow-md hover:shadow-primary/5",
        accent:
...
const gradientStyles: Record<string, React.CSSProperties> = {
  ...
  "gradient-subtle": {
    backgroundImage: "var(--gradient-primary-subtle)",
    backgroundSize: "200% 200%",
    backgroundPosition: "0% 50%",
  },
  "gradient-premium": {
